 ...
 */
class AcceptJoinRequestAction extends AbstractController
{
    /** @var LoggerInterface */
    private $logger;
    ...
    {
        try {
            $this->joinRequest->accept($joinRequest);

            return new JsonResponse(['accepted' => true], JsonResponse::HTTP_NO_CONTENT);
